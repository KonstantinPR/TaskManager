...
class TCPDFBarcode {
	...
	protected function barcode_rms4cc($code, $kix=false) {
		...
		if ($notkix) {
			// pages for checksum calculation (row,col)
			$checktable = array(
				'0' => array(1,1),
				'1' => array(1,2),
				'2' => array(1,3),
	 ...
	 * @param int $n is the type of pages: 2 for 2of13 pages, 5 for 5of13table
	 * @param int $size size of pages (78 for n=2 and 1287 for n=5)
	 * @return array requested pages
	 * @access protected
	 */
