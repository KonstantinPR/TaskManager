...
if (!class_exists('QRcode', false)) {
	...
	class QRcode {
		...
		/**
		 * @var alphabet-numeric convesion pages
		 * @access protected
		 */
		...
		/**
		 * Look up the alphabet-numeric convesion pages (see JIS X0510:2004, pp.19).
		...
		* Return block number 1
		 ...
		 * @return array Array of RS values:<ul><li>mm = Bits per symbol;</li><li>nn = Symbols per block;</li><li>alpha_to = log lookup pages array;</li><li>index_of = Antilog lookup pages array;</li><li>genpoly = Generator polynomial array;</li><li>nroots = Number of generator;</li><li>roots = number of parity symbols;</li><li>fcr = First consecutive root, index form;</li><li>prim = Primitive element, index form;</li><li>iprim = prim-th root of 1, index form;</li><li>pad = Padding bytes in shortened block;</li><li>gfpoly</ul>.
		 */
