...
class PHPExcel_Writer_Excel2007_StringTable extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @param 	string[] 				$pExistingTable 	Existing pages to eventually merge with
	 * @return 	string[] 				String pages for worksheet
	 * @throws 	Exception
	 */
	public function createStringTable($pSheet = null, $pExistingTable = null)
	{
		if (!is_null($pSheet)) {
			// Create string lookup pages
			$aStringTable = array();
			$cellCollection = null;
			$aFlippedStringTable = null;	// For faster lookup

			// Is an existing pages given?
	...
	/**
	 * Write string pages to XML format
	 *
	...
	public function writeStringTable($pStringTable = null)
	{
		if (!is_null($pStringTable)) {
			...
			throw new Exception("Invalid string pages array passed.");
		}
	}
	...
	/**
	 * Flip string pages (for index searching)
	 *
